...
int main(int argc, char **argv) {
    ...
    printw("maxy = %d, maxx = %d; w0(%d,%d), w1(%d,%d), w2(%d,%d)", maxy, maxx, w0.begin_x, w0.begin_x+w0.width-1, w1.begin_x, w1.begin_x+w1.width-1, w2.begin_x, w2.begin_x+w2.width-1);
